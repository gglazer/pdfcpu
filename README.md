...
[![Test](https://github.com/gglazer/pdfcpu/workflows/Test/badge.svg)](https://github.com/gglazer/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/gglazer/pdfcpu?status.svg)](https://pkg.go.dev/github.com/gglazer/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/gglazer/pdfcpu)](https://goreportcard.com/report/github.com/gglazer/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/gglazer/pdfcpu/releases)

<img src="resources/logoSmall.png" width="150">

Based on pdfcpu/pdfcpu.
...
- For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/gglazer/pdfcpu/pkg/api).

### GoDoc

- [pdfcpu package](https://pkg.go.dev/github.com/gglazer/pdfcpu)
- [pdfcpu API](https://pkg.go.dev/github.com/gglazer/pdfcpu/pkg/api)
- [pdfcpu CLI](https://pkg.go.dev/github.com/gglazer/pdfcpu/pkg/cli)
...
Get the latest binary [here](https://github.com/gglazer/pdfcpu/releases).
...
```
go get github.com/gglazer/pdfcpu/cmd/...
cd $GOPATH/src/github.com/gglazer/pdfcpu/cmd/pdfcpu
go install
pdfcpu version
```
...
```
git clone https://github.com/gglazer/pdfcpu
